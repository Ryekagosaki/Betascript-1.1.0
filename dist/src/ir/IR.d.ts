...
export type IRStatement = IRVariableDeclaration | IRFunctionDeclaration | IRClassDeclaration | IRInterfaceDeclaration | IRTypeAliasDeclaration | IREnumDeclaration | IRDecoratorApplication | IRIfStatement | IRWhileStatement | IRForStatement | IRForEachStatement | IRReturnStatement | IRThrowStatement | IRTryStatement | IRExpressionStatement | IRBlockStatement | IRBreakStatement | IRContinueStatement;
...
export type IRType = IRPrimitiveType | IRArrayType | IRUnionType | IRTupleType | IRFunctionType | IRNullableType | IRObjectType | IRNamedType | IRGenericType | IRMappedType;
...
export type IRExpression = IRLiteral | IRIdentifier | IRBinaryExpression | IRUnaryExpression | IRAssignmentExpression | IRCallExpression | IRMemberExpression | IRNewExpression | IRSuperExpression | IRArrayExpression | IRObjectExpression | IRArrowFunction | IRConditionalExpression | IRTemplateExpression | IRSpreadExpression;
