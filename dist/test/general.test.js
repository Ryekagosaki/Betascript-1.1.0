...
const UjianFramework_1 = require("../src/runtime/UjianFramework");
...
teriak(anjing.bersuara())`;
    ...
    describe("Plugin System", () => {
        test("should allow plugin registration", () => {
            ...
            const c = new index_1.BetaCompiler();
            c.use(plugin);
    ...
    describe("CLI Target Mapping", () => {
        test("should support all 8 target languages", () => {
            ...
            for (const target of targets) {
                const code = compiler.compile(simpleSource, "test.beta", { target: target });
                expect(code.length).toBeGreaterThan(0);
            }
        });
    });
    ...
    describe("Ujian Testing Framework", () => {
        test("should parse test cases", () => {
            const framework = new UjianFramework_1.UjianFramework();
